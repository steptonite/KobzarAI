...
# 8. Перевірка встановленого. 🔴 22.08.2026: до цього дня setup.sh закінчувався
#    словом «Готово» і жодного разу не питав, чи те, що він поставив, справді
#    працює. Перша чужа установка через це виглядала успішною, а застосунок був
#    мертвий: моделі лежали в одному місці, панель шукала їх в іншому.
...
Якщо щось не працює — НЕ перевстановлюй наосліп і не видаляй стару копію:
  ./doctor.sh         скаже, що саме зламано
  ./doctor.sh --fix   полагодить те, що лагодиться безпечно
EOF
